...
C             These variables must contain the 2-by-2 block to be
C             multiplied to the elements of A.
C
C
...
C
C     DWORK   (input/output) DOUBLE PRECISION array, dimension (LDDWOR,2*M+3)
